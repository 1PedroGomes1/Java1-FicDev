...
public class BibliotecaService {
    ...
    public void realizarEmprestimo(int idLivro, int idUsuario) throws EmprestimoException {
        ...
        Usuario usuario = usuarioRepository.buscarPorId(idUusuario);
    ...
    public void realizarDevolucao(int idLivro, int idUsuario) throws DevolucaoExeption {
        Livro livro = livroRepository.buscarPorId(idLivro);
        Usuario usuario = usuarioRepository.buscarPorId(idUsuario);
        if (livro != null && usuario != null && !livro.isDisponivel() && usuario.getLivrosEmprestados().contains(livros)) {
